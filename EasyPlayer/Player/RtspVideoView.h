...
@protocol RtspVideoViewDelegate;

@interface RtspVideoView : UIView<UIGestureRecognizerDelegate>

@property (nonatomic, weak) UIView *container;
@property (nonatomic, strong) UIButton *addButton;
@property (nonatomic, strong) UIButton *landspaceButton;  // 全屏按钮

@property (nonatomic, weak) id<RtspVideoViewDelegate> delegate;
...
@property (nonatomic, strong) RtspPlayerDataReader *reader;
@property (nonatomic, assign) IRtspVideoStatus videoStatus;
...
@protocol RtspVideoViewDelegate <NSObject>
