...
@interface RtspVideoView() <UIScrollViewDelegate> {
...
- (void)startAudio {
    ...
    __weak RtspVideoView *weakSelf = self;
...
- (void)startPlay {
    ...
    __weak RtspVideoView *weakSelf = self;
    _reader = [[RtspPlayerDataReader alloc] initWithUrl:self.url];
...
- (void)setVideoStatus:(IRtspVideoStatus)videoStatus {
